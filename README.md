...
A simple JS class to be used in a `KeyringController`; such as the one used in [Bitcoin Wallet](https://github.com/bitcoin-swap/bitcoin-wallet.git)
, forked from [eth-simple-keyring](https://github.com/bitcoin-swap/bitcoin-simple-keyring)   
...
One of the goals of this class is to allow developers to easily add new signing strategies to Bitcoin Wallet. We call these signing strategies Keyrings, because they can manage multiple keys.
